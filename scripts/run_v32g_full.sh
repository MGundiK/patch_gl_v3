...
do
  ...
  python -u run.py \
    ...
    --model_id traffic_${pred_len}_v32g \
    --model $model_name \
    --data custom \
    --features M \
    --seq_len $seq_len \
    ...
    --gate_init $gate_init \
    --cv_rank $cv_rank \
    --placement $placement > logs/glpatch_hydra_v32g/${model_name}_traffic_${seq_len}_${pred_len}.log
  ...
  python -u run.py \
    ...
    --model_id electricity_${pred_len}_v32g \
    --model $model_name \
    --data custom \
    --features M \
    --seq_len $seq_len \
    ...
    --gate_init $gate_init \
    --cv_rank $cv_rank \
    --placement $placement > logs/glpatch_hydra_v32g/${model_name}_electricity_${seq_len}_${pred_len}.log
