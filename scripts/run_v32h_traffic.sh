...
mkdir -p ./logs/glpatch_hydra_v32h/Traffic
...
do
  ...
  python -u run.py \
    ...
    --model_id traffic_${pred_len}_v32h --model $model_name --data custom \
    ...
    > logs/glpatch_hydra_v32h/Traffic/${model_name}_${seq_len}_${pred_len}.log
done

echo "========== v3.2h Traffic complete =========="
