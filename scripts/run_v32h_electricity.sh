...
# GLPatch_Hydra v3.2h — Electricity
...
mkdir -p ./logs/glpatch_hydra_v32h/Electricity
...
do
  ...
  python -u run.py \
    ...
    --model_id electricity_${pred_len}_v32h --model $model_name --data custom \
    ...
    > logs/glpatch_hydra_v32h/Electricity/${model_name}_${seq_len}_${pred_len}.log
done

echo "========== v3.2h Electricity complete =========="
