...
mkdir -p ./logs/glpatch_hydra_v32h/Solar
...
do
  ...
  python -u run.py \
    ...
    --model_id solar_${pred_len}_v32h --model $model_name --data Solar \
    ...
    > logs/glpatch_hydra_v32h/Solar/${model_name}_${seq_len}_${pred_len}.log
done

echo "========== v3.2h Solar complete =========="
