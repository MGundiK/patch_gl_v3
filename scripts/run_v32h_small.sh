...
# GLPatch_Hydra v3.2h — Small datasets
...
mkdir -p ./logs/glpatch_hydra_v32h/{ETTh1,ETTh2,ETTm1,ETTm2,Weather,Exchange,ILI}
...
do
  ...
  python -u run.py \
    ...
    --model_id ETTh1_${pred_len}_v32h --model $model_name --data ETTh1 \
    ...
    > logs/glpatch_hydra_v32h/ETTh1/${model_name}_${seq_len}_${pred_len}.log

  echo "========== ETTh2 pred_len=${pred_len} =========="
  python -u run.py \
    --is_training 1 --root_path ./dataset/ --data_path ETTh2.csv \
    --model_id ETTh2_${pred_len}_v32h --model $model_name --data ETTh2 \
    --features M --seq_len $seq_len --pred_len $pred_len --enc_in 7 \
    --des 'Exp' --itr 1 --batch_size 2048 --learning_rate 0.0005 \
    --lradj 'sigmoid' --ma_type $ma_type --alpha $alpha --beta $beta \
    --gate_type $gate_type --gate_init $gate_init --cv_rank $cv_rank \
    > logs/glpatch_hydra_v32h/ETTh2/${model_name}_${seq_len}_${pred_len}.log

  echo "========== ETTm1 pred_len=${pred_len} =========="
  python -u run.py \
    --is_training 1 --root_path ./dataset/ --data_path ETTm1.csv \
    --model_id ETTm1_${pred_len}_v32h --model $model_name --data ETTm1 \
    --features M --seq_len $seq_len --pred_len $pred_len --enc_in 7 \
    --des 'Exp' --itr 1 --batch_size 2048 --learning_rate 0.0005 \
    --lradj 'sigmoid' --ma_type $ma_type --alpha $alpha --beta $beta \
    --gate_type $gate_type --gate_init $gate_init --cv_rank $cv_rank \
    > logs/glpatch_hydra_v32h/ETTm1/${model_name}_${seq_len}_${pred_len}.log

  echo "========== ETTm2 pred_len=${pred_len} =========="
  python -u run.py \
    --is_training 1 --root_path ./dataset/ --data_path ETTm2.csv \
    --model_id ETTm2_${pred_len}_v32h --model $model_name --data ETTm2 \
    --features M --seq_len $seq_len --pred_len $pred_len --enc_in 7 \
    --des 'Exp' --itr 1 --batch_size 2048 --learning_rate 0.0001 \
    --lradj 'sigmoid' --ma_type $ma_type --alpha $alpha --beta $beta \
    --gate_type $gate_type --gate_init $gate_init --cv_rank $cv_rank \
    > logs/glpatch_hydra_v32h/ETTm2/${model_name}_${seq_len}_${pred_len}.log

  echo "========== Weather pred_len=${pred_len} =========="
  python -u run.py \
    --is_training 1 --root_path ./dataset/ --data_path weather.csv \
    --model_id weather_${pred_len}_v32h --model $model_name --data custom \
    --features M --seq_len $seq_len --pred_len $pred_len --enc_in 21 \
    --des 'Exp' --itr 1 --batch_size 2048 --learning_rate 0.0005 \
    --lradj 'sigmoid' --ma_type $ma_type --alpha $alpha --beta $beta \
    --gate_type $gate_type --gate_init $gate_init --cv_rank $cv_rank \
    > logs/glpatch_hydra_v32h/Weather/${model_name}_${seq_len}_${pred_len}.log

  echo "========== Exchange pred_len=${pred_len} =========="
  python -u run.py \
    --is_training 1 --root_path ./dataset/ --data_path exchange_rate.csv \
    --model_id exchange_${pred_len}_v32h --model $model_name --data custom \
    --features M --seq_len $seq_len --pred_len $pred_len --enc_in 8 \
    --des 'Exp' --itr 1 --batch_size 32 --learning_rate 0.00001 \
    --lradj 'sigmoid' --ma_type $ma_type --alpha $alpha --beta $beta \
    --gate_type $gate_type --gate_init $gate_init --cv_rank $cv_rank \
    > logs/glpatch_hydra_v32h/Exchange/${model_name}_${seq_len}_${pred_len}.log
done
...
do
  ...
  python -u run.py \
    ...
    --model_id ili_${pred_len}_v32h --model $model_name --data custom \
    ...
    --gate_type $gate_type --gate_init $gate_init --cv_rank $cv_rank \
    > logs/glpatch_hydra_v32h/ILI/${model_name}_${seq_len}_${pred_len}.log
done

echo "========== v3.2h small datasets complete =========="
